...
export default function TokensPage() {
  ...
  return (
    <div className="p-6 space-y-6">
      <div>
        <h1 className="text-2xl font-semibold">Token Burn Breakdown</h1>
        <p className="text-sm text-muted-foreground mt-1">Last 14 days · Mock data (no activity.log found) · Fleet runs Claude Max plan</p>
      </div>
